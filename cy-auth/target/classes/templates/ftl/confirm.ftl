    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-5">
            <p class="navbar-text navbar-right">
                <a target="_blank" href="https://mingtian-group.com">技术支持</a>
            </p>
            <p class="navbar-text navbar-right">
                <a target="_blank" href="https://mingtian-group.com">${user.username}</a>
            </p>
        </div>
    </div>
</nav>
...
<footer>
    <p>support by: baidu.com</p>
    <p>email: <a href="mailto:117332652@qq.com">757007945@qq.com</a>.</p>
</footer>
</body>
</html>
